...
// UT99_ANDROID_V51F_HEADER_PATCHED
...
public:
	// UT99_ANDROID_GAMEPLAY_CAUSEINPUT_PUBLIC_V39B
public:
	// UT99_ANDROID_V51E_PUBLIC_CAUSE_INPUT_EVENT:
	// Android bridge helpers outside UNSDLViewport need to inject UE1 input.
	UBOOL CauseInputEvent( INT iKey, EInputAction Action, FLOAT Delta=0.0 );
	void AndroidNativeMouseDeltaV112( DWORD MouseFlags, INT DX, INT DY ); // UT99_ANDROID_NATIVE_MOUSE_GAMEPLAY_BUILD_FIX_V112
	void AndroidUpdateNativeMouseCaptureV113( UBOOL bMenuMode ); // UT99_ANDROID_NATIVE_MOUSE_RELATIVE_CAPTURE_V113
private:
private:
};
